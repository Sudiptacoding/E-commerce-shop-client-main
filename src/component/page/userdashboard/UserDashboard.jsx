                ...
                <div className="flex">
                    <div className={`${open ? "w-72" : "w-16"} duration-700 md:p-5  md:pt-8 shadow-lg shadow-[#00000036] h-screen bg-white relative`}>
                        ...
                        <ul className="menu">
                            {
                                user ? <>
                                    <li className="  md:w-full rounded-md mb-2  font-medium text-black hover:text-white"><NavLink to="/userdashboard/userprofile"> <FiHome className="text-xl" /><p className={`  ${!open && "hidden "}`}>Profile</p></NavLink></li>
                                    <li className="  md:w-full rounded-md mb-2  font-medium text-black hover:text-white"><NavLink to="/userdashboard/userinfo"> <MdOutlinePayment className="text-xl" /><p className={` ${!open && "hidden"}`}>Information</p></NavLink></li>
                                    <li className="  md:w-full rounded-md mb-2  font-medium text-black hover:text-white"><NavLink to="/userdashboard/userpassword"> <FaUserFriends className="text-xl" /><p className={` ${!open && "hidden"}`}>Change Password</p></NavLink></li>
